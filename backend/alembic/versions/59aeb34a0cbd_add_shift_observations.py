"""add_shift_observations

Revision ID: 59aeb34a0cbd
Revises: e2c6acd3105c
Create Date: 2025-07-01 19:43:21.601472
...
revision: str = '59aeb34a0cbd'
down_revision: Union[str, None] = 'e2c6acd3105c'
...
def upgrade() -> None:
    ...
    sa.Column('medical_notes', sa.Text(), nullable=True),
    sa.Column('cie10_code', sa.String(length=20), nullable=True),
    ...
    op.create_table('restraint_protocols',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('cared_person_id', sa.UUID(), nullable=False),
    sa.Column('institution_id', sa.Integer(), nullable=True),
    sa.Column('created_by_id', sa.UUID(), nullable=False),
    ...
    sa.Column('responsible_professional', sa.String(length=200), nullable=False),
    sa.Column('professional_license', sa.String(length=100), nullable=True),
    sa.Column('supervising_doctor', sa.String(length=200), nullable=True),
    sa.Column('status', sa.String(length=50), nullable=False),
    ...
    op.create_index(op.f('ix_restraint_protocols_cared_person_id'), 'restraint_protocols', ['cared_person_id'], unique=False)
    op.create_index(op.f('ix_restraint_protocols_created_by_id'), 'restraint_protocols', ['created_by_id'], unique=False)
    op.create_index(op.f('ix_restraint_protocols_id'), 'restraint_protocols', ['id'], unique=False)
    op.create_index(op.f('ix_restraint_protocols_institution_id'), 'restraint_protocols', ['institution_id'], unique=False)
    op.create_index(op.f('ix_restraint_protocols_protocol_type'), 'restraint_protocols', ['protocol_type'], unique=False)
    op.create_index(op.f('ix_restraint_protocols_status'), 'restraint_protocols', ['status'], unique=False)
    op.create_table('shift_observations',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('shift_type', sa.String(length=50), nullable=False, comment='Tipo de turno: morning, afternoon, night, 24h'),
    sa.Column('shift_start', sa.DateTime(), nullable=False, comment='Inicio del turno'),
    sa.Column('shift_end', sa.DateTime(), nullable=False, comment='Fin del turno'),
    sa.Column('observation_date', sa.DateTime(), nullable=False, comment='Fecha de la observación'),
    sa.Column('physical_condition', sa.String(length=50), nullable=True, comment='Estado físico: excellent, good, fair, poor, critical'),
    sa.Column('mobility_level', sa.String(length=50), nullable=True, comment='Nivel de movilidad: independent, assisted, wheelchair, bedridden'),
    sa.Column('pain_level', sa.Integer(), nullable=True, comment='Nivel de dolor (0-10)'),
    sa.Column('vital_signs', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Signos vitales: temperatura, presión, pulso, oxigenación'),
    sa.Column('skin_condition', sa.String(length=200), nullable=True, comment='Condición de la piel'),
    sa.Column('hygiene_status', sa.String(length=50), nullable=True, comment='Estado de higiene: excellent, good, fair, poor'),
    sa.Column('mental_state', sa.String(length=50), nullable=True, comment='Estado mental: alert, confused, drowsy, agitated, calm'),
    sa.Column('mood', sa.String(length=50), nullable=True, comment='Estado de ánimo: happy, sad, anxious, angry, neutral'),
    sa.Column('behavior_notes', sa.Text(), nullable=True, comment='Observaciones de comportamiento'),
    sa.Column('cognitive_function', sa.String(length=50), nullable=True, comment='Función cognitiva: normal, mild_impairment, moderate_impairment, severe_impairment'),
    sa.Column('communication_ability', sa.String(length=50), nullable=True, comment='Capacidad de comunicación: normal, limited, nonverbal'),
    sa.Column('appetite', sa.String(length=50), nullable=True, comment='Apetito: excellent, good, fair, poor, none'),
    sa.Column('food_intake', sa.String(length=50), nullable=True, comment='Ingesta de alimentos: full_meal, partial_meal, snacks_only, refused'),
    sa.Column('fluid_intake', sa.String(length=50), nullable=True, comment='Ingesta de líquidos: adequate, limited, poor, refused'),
    sa.Column('swallowing_difficulty', sa.Boolean(), nullable=True, comment='Dificultad para tragar'),
    sa.Column('special_diet_notes', sa.Text(), nullable=True, comment='Notas sobre dieta especial'),
    sa.Column('bowel_movement', sa.String(length=50), nullable=True, comment='Movimiento intestinal: normal, constipated, diarrhea, none'),
    sa.Column('urinary_output', sa.String(length=50), nullable=True, comment='Producción urinaria: normal, decreased, increased, none'),
    sa.Column('incontinence_episodes', sa.Integer(), nullable=True, comment='Episodios de incontinencia'),
    sa.Column('catheter_status', sa.String(length=50), nullable=True, comment='Estado de catéter: none, foley, suprapubic, condom'),
    sa.Column('medications_taken', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Medicamentos tomados durante el turno'),
    sa.Column('medications_missed', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Medicamentos no tomados'),
    sa.Column('side_effects_observed', sa.Text(), nullable=True, comment='Efectos secundarios observados'),
    sa.Column('medication_notes', sa.Text(), nullable=True, comment='Notas sobre medicación'),
    sa.Column('activities_participated', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Actividades en las que participó'),
    sa.Column('social_interaction', sa.String(length=50), nullable=True, comment='Interacción social: active, passive, withdrawn, aggressive'),
    sa.Column('exercise_performed', sa.Boolean(), nullable=True, comment='Ejercicio realizado'),
    sa.Column('exercise_details', sa.Text(), nullable=True, comment='Detalles del ejercicio'),
    sa.Column('safety_concerns', sa.Text(), nullable=True, comment='Preocupaciones de seguridad'),
    sa.Column('incidents_occurred', sa.Boolean(), nullable=True, comment='Incidentes ocurridos'),
    sa.Column('incident_details', sa.Text(), nullable=True, comment='Detalles de incidentes'),
    sa.Column('fall_risk_assessment', sa.String(length=50), nullable=True, comment='Evaluación de riesgo de caída: low, medium, high'),
    sa.Column('restraint_used', sa.Boolean(), nullable=True, comment='Uso de sujeción'),
    sa.Column('restraint_details', sa.Text(), nullable=True, comment='Detalles de sujeción'),
    sa.Column('family_contact', sa.Boolean(), nullable=True, comment='Contacto con familia'),
    sa.Column('family_notes', sa.Text(), nullable=True, comment='Notas sobre contacto familiar'),
    sa.Column('doctor_contact', sa.Boolean(), nullable=True, comment='Contacto con médico'),
    sa.Column('doctor_notes', sa.Text(), nullable=True, comment='Notas sobre contacto médico'),
    sa.Column('handover_notes', sa.Text(), nullable=True, comment='Notas para el siguiente turno'),
    sa.Column('attached_files', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Archivos adjuntos: fotos, videos, documentos'),
    sa.Column('status', sa.String(length=50), nullable=True, comment='Estado: draft, completed, reviewed, archived'),
    sa.Column('is_verified', sa.Boolean(), nullable=True, comment='Observación verificada'),
    sa.Column('verified_by', sa.UUID(), nullable=True, comment='Usuario que verificó'),
    sa.Column('verified_at', sa.DateTime(), nullable=True, comment='Fecha de verificación'),
    sa.Column('cared_person_id', sa.UUID(), nullable=False),
    sa.Column('caregiver_id', sa.UUID(), nullable=False),
    sa.Column('institution_id', sa.Integer(), nullable=True, comment='Institución asociada'),
...
def downgrade() -> None:
    ...
    op.drop_table('shift_observations')
    op.drop_index(op.f('ix_restraint_protocols_status'), table_name='restraint_protocols')
    op.drop_index(op.f('ix_restraint_protocols_protocol_type'), table_name='restraint_protocols')
    op.drop_index(op.f('ix_restraint_protocols_institution_id'), table_name='restraint_protocols')
    op.drop_index(op.f('ix_restraint_protocols_id'), table_name='restraint_protocols')
    op.drop_index(op.f('ix_restraint_protocols_created_by_id'), table_name='restraint_protocols')
    op.drop_index(op.f('ix_restraint_protocols_cared_person_id'), table_name='restraint_protocols')
    op.drop_table('restraint_protocols')
